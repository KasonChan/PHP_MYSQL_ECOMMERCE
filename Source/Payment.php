    	...
    	<div class=PageContainer>
			...
			<?php
				...
				{	
					...
					echo "<input type=\"text\" name=\"price\" value=\"$price\"  style=\"display:none\"/>";
					echo "<input type=\"text\" name=\"method\" value=\"$method\"  style=\"display:none\"/>";
					echo "<input type=\"text\" name=\"payment\" value=\"$payment\"  style=\"display:none\"/>";
					echo "<input type=\"text\" name=\"FinalAmount\" value=\"$FinalAmount\"  style=\"display:none\"/>";
	    		...
	    		echo "<input type=\"text\" name=\"total\" value=\"$total\"  style=\"display:none\"/>" . "<input type=\"submit\" class=Button value=\"Confirm Order\" />";
	    		echo "</form>";
