    ...
    <body>
    	<div class=PageContainer>
			...
			<?php 
				...
				$IDs = getProductIDFromEmail($email);
				// echo $IDs[0];
				...
				foreach($IDs as $ID)
				{
					...
					if(trim(getEmail($IP)) != '')
					{
						echo "<form action=\"RemoveList.php\" method=\"post\">";
			    		echo "<p>" . "<input type=\"text\" name=\"name\" value=\"$ID\" style=\"display:none\" />" . "<input type=\"submit\" class=Button value=\"Remove Item\" />" . "</p>";
		    			echo "</form>";
		    		}
					echo "<BR>";
				}
