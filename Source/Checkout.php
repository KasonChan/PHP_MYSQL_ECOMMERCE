    	...
    	<div class=PageContainer>
			...
			<?php
				...
				{	
					...
					$prices = getShippingPrice();
					$methods = getShippingMethod();
					foreach (array_combine($methods, $prices) as $method => $price)
					{
						echo "<input type=\"radio\" name=\"price\" value=\"$price\" />" . " ";
					...
					{
						echo "<input type=\"radio\" name=\"payment\" value=\"$payment\" />" . " " . $payment . "<BR>";
					}
					echo "</td></tr>";
		    		echo "</table>";
	    		}
	    		...
	    		echo "<input type=\"text\" name=\"total\" value=\"$total\"  style=\"display:none\"/>" . "<input type=\"submit\" class=Button value=\"Make payment\" />";
	    		echo "</form>";
